  ...
  <body>
    ...
    <div class="humberger__menu__wrapper">
      <div class="humberger__menu__logo">
        <a href="/"><img src="{{ asset('frontend/img/logo.png') }}" alt="" style="width: 95px" /></a>
      </div>
      <div class="humberger__menu__cart">
        <ul>
          <li>
            <a href="#"><i class="fa fa-heart"></i> <span>2</span></a>
          </li>
          <li>
      ...
      <div class="humberger__menu__widget">
          ...
          <div class="header__top__right__language">
            <div class="header__top__right__auth">
              <a href="{{ route('login') }}"><i class="fa fa-user"></i> {{ auth()->user()->username }}</a>
            </div>
        ...
        <ul>
                <li>
                    ...
                    <ul class="language-dropdown">
                        <li><a href="#"><img src="frontend/img/theme/flag-fr.png" alt="">Français</a></li>
                        <li><a href="#"><img src="frontend/img/theme/flag-mr.png" alt="">Arabc</a></li>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                ...
                <div
                  class="header__top__right__language header__top__right__auth"
                >
                  <a class="d-inline" href="/admin/dashboard"
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              <div class="footer__about__logo">
                <a href="./index.html"><img src="{{ asset('frontend/img/logo.png') }}" alt="" style="width: 100px"/></a>
              </div>
              <ul>
                <li>Address: Rabat-Salé-Kénitra</li>
                <li>Phone: +2126754326178</li>
                <li>Email: contact.happyshopp@gmail.com</li>
              </ul>
            </div>
          </div>
